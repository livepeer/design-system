    ...
    <Box>
      <Banner id="banner">
        ...
        <Text size="2" css={{ fontWeight: 500 }}>
          The Livepeer explorer got a redesign!
        </Text>
      ...
      <Box css={{ bc: "$loContrast", height: "100%" }}>
        ...
        <Section size="3">
          ...
          <Section size="1" css={{ bc: "$panel" }}>
            <Text as="p" size="4" css={{ ta: "center" }}>
              Section 1
            </Text>
          </Section>
          <Section size="2" css={{ bc: "$panel", my: "$1" }}>
            <Text as="p" size="4" css={{ ta: "center" }}>
              Section 2
            </Text>
          </Section>
          <Section size="3" css={{ bc: "$panel" }}>
            <Text as="p" size="4" css={{ ta: "center" }}>
              Section 3
            </Text>
          </Section>
        ...
        <Section size="3">
          ...
          <Container size="2" css={{ my: "$9" }}>
            <Paragraph>
              ...
              The reason we are using prose here is because the most common use
              case for this container size is longform text. So we are
            ...
            >
              <Box>
                <Text as="p" size="4" css={{ lineHeight: "27px" }}>
                  ...
                  narrow text container. The reason we are using text here is
        ...
        <Section size="3">
          <Container size="2">
            ...
            <Flex direction="column" align="center" gap="6">
              <Box css={{ width: "$8", height: "$8", bc: "$primary9" }}></Box>
              <Box css={{ width: "$5", height: "$5", bc: "$primary9" }}></Box>
              <Box css={{ width: "$7", height: "$7", bc: "$primary9" }}></Box>
            </Flex>
          </Container>
        </Section>
        <Flex css={{ jc: "center" }}>
        ...
        <Section size="3">
          <Container size="2">
            ...
            <Grid columns="4" align="center" gapX="3" gapY="6">
              <Box css={{ height: "$9", bc: "$primary9" }}></Box>
              <Box css={{ height: "$7", bc: "$primary9" }}></Box>
              <Box css={{ height: "$7", bc: "$primary9" }}></Box>
              <Box css={{ height: "$7", bc: "$primary9" }}></Box>
              <Box css={{ height: "$7", bc: "$primary9" }}></Box>
              <Box css={{ height: "$7", bc: "$primary9" }}></Box>
          ...
          <Container size="2">
            ...
            <Flex css={{ fd: "column", gap: "$4" }}>
              ...
              <Paragraph size="1">
                ...
                read in a blog post. The reason we are using prose here is
                because the most common use case for this container size is
                longform text. So we are previewing some longform text here so
                we can make sure the container width provides an optimal line
        ...
        <Section size="3">
          <Container size="2">
            ...
            <Paragraph>
              ...
              Traditional business literature will not help you solve it- most
              of that stuff is focused on life after product/market fit, after
              the Trough of Sorrow. A lot of startup stuff is focused on the
              initial phases, when you do not have a team, idea, or investors.
            </Paragraph>
          </Container>
        </Section>
        <Flex css={{ jc: "center" }}>
        ...
        <Section size="3">
          <Container size="2">
            ...
            <Paragraph>
              ...
              positive states. Traditional business literature will not help you
              solve it- most of that stuff is focused on life after
              product/market fit, after the Trough of Sorrow. A lot of startup
              stuff is focused on the initial phases, when you do not have a
          ...
          <Container size="3">
            ...
            <Flex css={{ gap: "$3" }}>
              <Box css={{ width: 250 }}>
                <Card css={{ p: "$3" }}>
                  <Heading css={{ mb: "$2" }}>
                    Livepeer now supports staking on Arbitrum.
                  </Heading>
                  <Text
                    size="3"
                    css={{ color: "$neutral11", lineHeight: "23px" }}
                  >
                    Livepeer is a developer platform for decentralized video
                    streaming powered by a token-coordinated network of video
        ...
        <Section size="3">
          <Container size="2">
            ...
            <Box css={{ mb: "$6" }}>
              <Card variant="active" css={{ p: "$4" }}>
                <Heading css={{ mb: "$2" }}>Migrate to Arbitrum</Heading>
                <Text
                  size="3"
                  css={{ color: "$neutral11", lineHeight: "23px" }}
                >
                  In an effort to reduce the cost of transacting on Ethereum the
                  Livepeer protocol has added support for Arbitrum, an Ethereum
                  “layer 2”.
                </Text>
                <Flex css={{ mt: "$3" }}>
                  <Button variant="primary" size="3">
        ...
        <Section size="3">
          <Container size="3">
            ...
            <Flex css={{ borderBottom: "1px solid $neutral6" }}>
              <TabLink href="#" active>
                <Box css={{ mr: "$1" }}>
                  <CodeIcon />
                </Box>
              ...
              <ContextMenuTrigger>
                <Flex
                  css={{
                    ...
                    height: "$9",
                    bc: "$neutral2",
                    border: "2px dashed $colors$neutral6",
                    br: "$2",
                  }}
                >
